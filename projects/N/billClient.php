...
$result = mysqli_query($conn,"SELECT * FROM bill,owners where bill.owners_id ='$session' GROUP BY bill.owners_id");
...
$result2 = mysqli_query($conn,"SELECT * FROM bill,owners where bill.owners_id='$session' GROUP BY bill.owners_id ");
