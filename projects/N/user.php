            ...
            <div class="panel-body">
                <?php
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                        ...
                        echo "<td>";
                        // Edit icon
                        echo "<a rel='facebox' href='edituser.php?id=".$row['id']."'><button class=\"btn btn-default btn-xs\"><span class=\"glyphicon glyphicon-pencil\"></span></button></a>";
                        // Delete icon
                        echo "<a href='deleteuser.php?id=".$row['id']."'><button class=\"btn btn-danger btn-xs\"><span class=\"glyphicon glyphicon-trash\"></span></button></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    echo "</table>";
