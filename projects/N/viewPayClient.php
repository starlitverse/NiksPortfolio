...
html 
{ 
    background-image:url('g1.gif'); background-repeat:repeat; 
}
</script>
</head>
<body style=" background-size:cover; font-family:'Courier New', Courier;">
<style type="text/css">
#data { margin: 0 auto; width:1300px; padding:20px; border:#066 thin ridge; height:600px; }

</style>
<div id="data">
<center>
<h4><center><b>Payment Portal</b></center></h4>
<p>ESPSN - ESSP</p>
...
<tr><td>Client ID</td><td><i>SMART/00<?php echo $id; ?></i></td> </tr>
<tr><td>First Name:</td><td><b><i><?php echo $fname; ?></i></b></td> <td>Last Name:</td><td><b><i><?php echo $lname; ?></i></b></td></tr>
...
?>
<tr><td>Casher:                      </td><td>Signature:_____________</td></tr>
...
class=" glyphicon glyphicon-print"></span>&nbsp;Print Bill</button>&nbsp;<a href="billClient.php"><button class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Go back</button></a></CENTER>
</body>
</html>